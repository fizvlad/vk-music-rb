...
class TestVkMusic < MiniTest::Test
  def test_user_link_with_id
    ...
    assert_equal(51_842_614, id, "Ids don't match")
  end
  ...
  def test_group_link_with_id
    ...
    assert_equal(-39_786_657, id, "Ids don't match")
  end
